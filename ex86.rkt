...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex86) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
; Editor -> Number
; compute size of the editor
(check-expect (editor-size (make-editor "hello" "world")) 10)
(check-expect (editor-size (make-editor "hello" "")) 5)
(check-expect (editor-size (make-editor "" "")) 0)
...
; if editor size is alread equal to MAX-EDITOR-SIZE
; ignore the insert
(check-expect (insert (make-editor "hello" "world") "1")
              (make-editor "hello1" "world"))
(check-expect (insert (make-editor "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" "") "1")
              (make-editor "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" ""))
