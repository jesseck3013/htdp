...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex43-2) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
;; tree scene
(define tree
...
; given: 1, expect 3
; given: 2, expect 6
(define (x-position time)
  (* time 3))

; number -> number
; time -> y position
; convert ellapsed time to y position and make a sine wave
(define (y-position time)
  (+ Y-CAR
     (* (sin (/ time pi)) 10)))
